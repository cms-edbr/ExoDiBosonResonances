...
## THIS PART SHOULD CHANGE ACCORDINGLY WITH THE OUTPUTDIR ON EOS ##

$eosPath = "/eos/cms/store";
#$eosUserPath1 = "/user/".$eosUserName;
#$eosUserPath1 = "/group/phys_exotica/leptonsPlusJets/ExoDiBosonResonances/".$eosUserName;
$eosUserPath1 = "/cmst3/group/exovv/".$eosUserName;

###################################################################

#
#$eosUserPath2 = $eosUserPath1."/".$eosUserStorageDir;
$eosUserPath2 = $eosUserPath1;
$eosUserPath3 = $eosUserPath2."/".$tagname."\_".$date;
$fullEosPath = $eosPath.$eosUserPath3;
$newPath = "\/".$tagname."\_".$date;
...
#     }
	...
	{
	    $templateCMSSWFileLine = "    fileName = cms.untracked.string\(\"$outputfile\"\)\,";
	    #print("$templateCMSSWFileLine\n");
	}
...
#	}
	...
	if($templateCrabFileLine=~/THISUSERREMOTEDIR/)
	{
	    ...
	    $templateCrabFileLine = "user_remote_dir = $newPath";
	    #print("$templateCrabFileLine\n");
	}
...
sub help(){
    print "Usage: ./createJobsWithCrabEOS_PHYEXO.pl -d <storageDir> -v <tagname> -i <inputList> -t <templateCrab> -c <myCMSSWconfig> -n <EOSUserName> -p <publishName> [-r <runNumber> optional] [-j <jsonFile> mandatory in JSON MODE] [-h <help?>] \n";
    print "See https://twiki.cern.ch/twiki/bin/view/CMS/ExoticaLeptoquarkShiftMakeRootTuplesV22012 for more details \n";
    print "Example1 (NORMAL MODE): ./createJobsWithCrabEOS_PHYEXO.pl -d `pwd`/RootNtuple -v V00-03-07-DATA-xxxxxx-yyyyyy -i inputList.txt -t template_crab_grid_copyToEOS.cfg -c rootTupleMaker_CRAB_DATA_2012_53X_cfg.py -n <EOSUserName> -p <publishName> \n";
    print "Example2 (NORMAL MODE + RUN SELECTION): ./createJobsWithCrabEOS_PHYEXO.pl -d `pwd`/RootNtuple -v V00-03-07-DATA-xxxxxx-yyyyyy -i inputList.txt -t template_crab_grid_copyToEOS.cfg -c rootTupleMaker_CRAB_DATA_2012_53X_cfg.py -n <EOSUserName> -p <publishName> -r 132440 \n";
    print "Example3 (JSON MODE): ./createJobsWithCrabEOS_PHYEXO.pl -d `pwd`/RootNtuple -v V00-03-07-DATA-xxxxxx-yyyyyy -i inputList.txt -t template_crab_grid_copyToEOS_JSON.cfg -c rootTupleMaker_CRAB_DATA_2012_53X_cfg.py -n <EOSUserName> -p <publishName> -j JSON.txt \n";
    ...
    print "-p <publishName>:          choose the name for publication on DBS/DAS \n";
